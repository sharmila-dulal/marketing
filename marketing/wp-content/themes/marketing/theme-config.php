<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'general-opt',
        'desc'             => __( 'These are general options', 'redux-framework-demo' ),
...
if ( ! function_exists( 'mega_magazine_default_options' ) ) :
    ...
    function mega_magazine_default_options() {
        ...
        $defaults['breaking_news_text']         = esc_html__( 'Breaking News', 'marketing' );
        $defaults['breaking_news_cat']          = '';
        $defaults['breaking_news_number']       = 5;

        $defaults['enable_breadcrumb']          = true;
        $defaults['breadcrumb_text']            = esc_html__( 'Home', 'marketing' );
        
        $defaults['sticky_sidebar']             = true;
        $defaults['blog_layout']                = 'right-sidebar';
        $defaults['readmore_text']              = esc_html__( 'Read More', 'marketing' );
        ...
        $defaults['related_posts_text']         = esc_html__( 'Related Posts', 'marketing' );
        $defaults['enable_related_carousel']    = true;
        $defaults['related_posts_number']       = 5;

        $defaults['enable_about_author']        = true;
        $defaults['about_author_text']          = esc_html__( 'About', 'marketing' );
        $defaults['view_post_text']             = esc_html__( 'Read All Posts By', 'marketing' );
        
        $defaults['copyright_text']             = esc_html__( 'Copyright &copy; All rights reserved.', 'marketing' );
